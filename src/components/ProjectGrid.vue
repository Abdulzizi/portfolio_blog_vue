<template>
    <div class="w-full">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 w-full mb-8 md:mb-4" :class="containerClass">
        ...
        <div v-if="hasMoreProjects && showMoreButton" class="text-center my-8">
