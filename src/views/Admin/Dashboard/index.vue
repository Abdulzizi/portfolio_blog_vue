                            ...
                            <div class="space-y-4">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span
                                            class="px-2 py-1 text-xs font-medium bg-green-100 text-green-800">Published</span>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span
                                            class="px-2 py-1 text-xs font-medium bg-yellow-100 text-yellow-800">Draft</span>
                                        <button class="text-gray-400 hover:text-gray-600">
                                            <Edit class="w-4 h-4" />
                                        </button>
                                    </div>
